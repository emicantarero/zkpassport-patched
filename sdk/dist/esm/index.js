...
const { getAlpha3Code, registerLocale } = pkg;
...
import { createEncryptedJsonRpcRequest } from "./json-rpc.js";
import { decrypt, generateECDHKeyPair, getSharedSecret } from "./encryption.js";
import { noLogger as logger } from "./logger.js";
import { inflate } from "pako";
import i18en from "i18n-iso-countries/langs/en.json" assert { type: "json" };
import { Buffer } from "buffer/index.js";
import { sha256 } from "@noble/hashes/sha256";
import { hexToBytes } from "@noble/hashes/utils";
import ZKPassportVerifierAbi from "./assets/abi/ZKPassportVerifier.json" assert { type: "json" };
