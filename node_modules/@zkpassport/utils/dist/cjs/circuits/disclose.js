...
exports.DisclosedData = void 0;
exports.formatName = formatName;
exports.parseDocumentType = parseDocumentType;
exports.getDisclosedBytesFromMrzAndMask = getDisclosedBytesFromMrzAndMask;
exports.parseDate = parseDate;
exports.createDisclosedDataRaw = createDisclosedDataRaw;
exports.getDiscloseBytesProofPublicInputCount = getDiscloseBytesProofPublicInputCount;
exports.getDiscloseFlagsProofPublicInputCount = getDiscloseFlagsProofPublicInputCount;
exports.getDiscloseParameterCommitment = getDiscloseParameterCommitment;
exports.getDiscloseEVMParameterCommitment = getDiscloseEVMParameterCommitment;
...
function getDisclosedBytesFromMrzAndMask(mrz, mask) {
    ...
    return (0, utils_1.rightPadArrayWithZeros)(Array.from(disclosedBytes), 90);
}
class DisclosedData {
    constructor(data) {
 ...
 */
function getDiscloseBytesProofPublicInputCount() {
    return 5;
}
/**
 ...
 * @returns The number of public inputs.
 */
function getDiscloseFlagsProofPublicInputCount() {
    return 73;
}
/**
...
async function getDiscloseParameterCommitment(discloseMask, disclosedBytes) {
    const parameterCommitment = await (0, poseidon2_1.poseidon2HashAsync)([
        BigInt(_1.ProofType.DISCLOSE),
