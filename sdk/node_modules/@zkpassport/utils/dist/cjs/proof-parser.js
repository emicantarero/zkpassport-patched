...
exports.proofToFields = proofToFields;
exports.getNumberOfPublicInputsFromProof = getNumberOfPublicInputsFromProof;
exports.getPublicInputs = getPublicInputs;
exports.getProofWithoutPublicInputs = getProofWithoutPublicInputs;
exports.getProofData = getProofData;
const END_OF_PUBLIC_INPUTS_BYTES = "0000000000000000000000000000000000000000000000042ab5d6d1986846cf";
/**
 * Convert a proof in hex format to an array of fields.
 * @param proof - The proof to convert.
 * @returns An array of fields.
 */
function proofToFields(proof, startIndex = 4) {
 ...
 */
function getNumberOfPublicInputsFromProof(proofAsFields) {
    ...
    const endOfPublicInputsIndex = proofAsFields.findIndex((field) => field === endOfPublicInputsBytesHex);
 ...
 */
function getProofData(proof, publicInputsNumber, proofStartIndex = 4) {
