...
import { OIDS_TO_DESCRIPTION } from "./cms/constants.js";
import { getECDSAInfo, getPrivateKeyUsagePeriod, getRSAInfo, getRSAPSSParams, getSubjectKeyId, getBitSizeFromCurve, } from "./cms/utils.js";
import { getAuthorityKeyId } from "./cms/utils.js";
export function parseCertificate(content) {
    ...
    // Get the public key
    const spkiAlgorithm = OIDS_TO_DESCRIPTION[x509.tbsCertificate.subjectPublicKeyInfo.algorithm
    ...
    const signatureAlgorithm = OIDS_TO_DESCRIPTION[x509.tbsCertificate.signature.algorithm] ?? x509.tbsCertificate.signature.algorithm;
    const publicKeyType = OIDS_TO_DESCRIPTION[x509.tbsCertificate.subjectPublicKeyInfo.algorithm
        .algorithm] ?? x509.tbsCertificate.subjectPublicKeyInfo.algorithm.algorithm;
...
export function parseCertificates(pemContent) {
    const certificates = [];
    try {
