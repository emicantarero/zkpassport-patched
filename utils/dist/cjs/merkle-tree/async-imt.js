...
class AsyncIMT {
    ...
    constructor(hash, depth, arity = 2) {
        (0, utils_1.requireFunction)(hash, "hash");
        (0, utils_1.requireNumber)(depth, "depth");
        (0, utils_1.requireNumber)(arity, "arity");
     ...
     */
    indexOf(leaf) {
        (0, utils_1.requireTypes)(leaf, "leaf", ["number", "string", "bigint"]);
        return this._nodes[0].indexOf(leaf);
    }
    async initialize(zeroValue, leaves = []) {
        (0, utils_1.requireTypes)(zeroValue, "zeroValue", ["number", "string", "bigint"]);
        (0, utils_1.requireObject)(leaves, "leaves");
    ...
    async update(index, newLeaf) {
        (0, utils_1.requireNumber)(index, "index");
    ...
    static async verifyProof(proof, hash) {
        (0, utils_1.requireObject)(proof, "proof");
        (0, utils_1.requireTypes)(proof.root, "proof.root", ["number", "string", "bigint"]);
        (0, utils_1.requireTypes)(proof.leaf, "proof.leaf", ["number", "string", "bigint"]);
        (0, utils_1.requireArray)(proof.siblings, "proof.siblings");
        (0, utils_1.requireArray)(proof.pathIndices, "proof.pathIndices");
        let node = proof.leaf;
