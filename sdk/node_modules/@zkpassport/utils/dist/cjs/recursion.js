...
exports.getOuterCircuitInputs = getOuterCircuitInputs;
exports.getCertificateRegistryRootFromOuterProof = getCertificateRegistryRootFromOuterProof;
exports.getCurrentDateFromOuterProof = getCurrentDateFromOuterProof;
exports.getScopeFromOuterProof = getScopeFromOuterProof;
exports.getSubscopeFromOuterProof = getSubscopeFromOuterProof;
exports.getNullifierFromOuterProof = getNullifierFromOuterProof;
exports.getParamCommitmentsFromOuterProof = getParamCommitmentsFromOuterProof;
const _1 = require(".");
function getOuterCircuitInputs(cscToDscProof, dscToIdDataProof, integrityCheckProof, disclosureProofs) {
    const certificateRegistryRoot = cscToDscProof.publicInputs[0];
    const dateBytes = integrityCheckProof.publicInputs
        .slice(0, 8)
        .map((x) => Number(x) - 48)
        .map((x) => x.toString());
    const currentDate = (0, _1.convertDateBytesToDate)(dateBytes.join(""));
    ...
    return {
        ...
        current_date: (0, _1.getFormattedDate)(currentDate),
        service_scope: scope,
...
function getCurrentDateFromOuterProof(proofData) {
    const dateBytes = proofData.publicInputs
        ...
        .map((x) => Number(x) - 48)
        .map((x) => x.toString());
    const date = (0, _1.convertDateBytesToDate)(dateBytes.join(""));
    return date;
}
/**
