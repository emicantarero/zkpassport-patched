...
exports.getHashAlgorithmName = getHashAlgorithmName;
exports.getSignatureAlgorithmName = getSignatureAlgorithmName;
exports.decodeOID = decodeOID;
exports.oids = {
...
function getOIDName(oid) {
    if (exports.oids[oid]) {
        return exports.oids[oid].d;
    }
    else {
        return oid;
    }
}
function getHashAlgorithmName(oid) {
    if (exports.oids[oid]) {
        return exports.oids[oid].d.replace("-", "").toUpperCase();
    }
    else {
        return oid;
    }
...
function getSignatureAlgorithmName(oid) {
    if (exports.oids[oid]) {
        return exports.oids[oid].d.replace("-", "");
    }
    else {
        return oid;
    }
