 ...
 */
export function proofToFields(proof, startIndex = 4) {
 ...
 */
export function getNumberOfPublicInputsFromProof(proofAsFields) {
 ...
 */
export function getPublicInputs(proofAsFields, publicInputsNumber) {
 ...
 */
export function getProofWithoutPublicInputs(proofAsFields, publicInputsNumber) {
 ...
 */
export function getProofData(proof, publicInputsNumber, proofStartIndex = 4) {
